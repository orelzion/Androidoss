...
# מה זה קוטלין?
קוטלין היא שפת תכנות מודרנית שפותחה על ידי [JetBrains](http://jetbrains.com/) (אותה חברה שמפתחת את אנראויד סטודיו) בשנת 2011. בשנת 2017 היא הוכרזה כשפה רשמית לפיתוח לאנדרואיד על ידי גוגל, וכיום כל המדריכים באתר של גוגל כוללים דוגמאות קוד גם בקוטלין. 
...
זה בא לידי ביטוי בכך שקוטלין נטשה את סימן ה `;` שבא לסמן סוף פקודה בג'אווה, בקוטלין גם אין `new` כדי לאתחל אובייקט פשוט קוראים לקונסטרקור שלו ישירות.
...
מכך שזה מופיע בעולם ניתן להבין שמדובר בסוגיה שכואבת מאוד לאנשי ג'אווה, וזה נכון, אבל מה זה לעזאזל?!
...
אבל בפעם השניה, כבר אין לנו אובייקט של כלב, מי שמייצג אותו - `dog` - הוא כעת null, ג'אווה לא יודעת מה לעשות עם הפקודה שלכם ואילו לה שום דרך להריץ אותה, ולכן האפליקציה מתרסקת. לא כיף.

אבל רגע, אתם עוצרים אותי. למה שבגלל נרצה להפוך משהו לnull?
...
יש עוד בעיות שיכולות לצוץ בשיתוף של קוד בין שלי השפות, למשל העובדה שבג'אווה יש פרימיטיביים ובקוטלין רק אובייקטים יכולה לפעמים לבלבל, נניח והגדרנו משתנה מסוג `Int` בקוטלין ואנחנו פונים אליו מג'אווה, אנחנו יכולים להניח בטעות שערך הדיפולט (ברירת המחדל) שלו יהיה אפס כמו בג'אווה, אבל זה לא נכון, ערך הדיפולט יהיה בכלל null. 
...
זהו, זה השנקל שלח בעניין. אוהבות קוטלין? לא מסוגלות לזוז בלי ג'אווה? יאללה, תבעירו אש בתגובות
